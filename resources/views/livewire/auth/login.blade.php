  ...
  <div class="bg-primary/80 border border-mywhite/30 rounded-2xl p-8  mt-3 mb-3 w-full max-w-sm">
    ...
    <form class="space-y-3">
      <div>
        ...
        <input type="email" id="email" class="mt-1 w-full rounded-lg bg-mywhite/20 border border-mywhite/30 px-4 py-1 text-myblack placeholder-white/40 focus:border-mywhite/40 focus:ring focus:ring-mywhite/20">
      </div>

      <div>
        <label for="password" class="block text-sm text-mywhite font-semibold">Mot de passe</label>
        <input type="password" id="password" class="mt-1 w-full rounded-lg bg-mywhite/20 border border-mywhite/30 px-4 py-1 text-myblack placeholder-white/40 focus:border-white/40 focus:ring focus:ring-white/20">
      </div>
    ...
    <div class="flex justify-center gap-4">
      <button class="w-12 h-12 rounded-xl bg-mywhite/10 border border-mywhite/30 cursor-pointer flex items-center justify-center hover:bg-mywhite/20">
