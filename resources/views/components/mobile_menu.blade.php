<div id="mobile-menu"
    class="fixed top-0 right-0 h-full w-64 bg-primary text-accent font-semibold p-6 transform translate-x-full transition-transform duration-300 lg:hidden z-100">
